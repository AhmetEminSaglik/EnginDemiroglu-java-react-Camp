export class Customer{ //export public yerine kullaniliyor
...
// asagidaki kurs js kampi 1. derse aittir.
// class Customer {
//     constructor(id, customerNumber) {
//         this.id = id
//         this.customerNumber = customerNumber
...
// ]
// print("<ul>")
// products.map(product => print(`<li>${product.name}</li> ${product.unitPrice}`))
//  // `` ile '' arasinda cok fark var, `` olan {$var} olarak kullanilarak  deger yazdirir
// print("</ul>")
...
// console.log("---------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
// let sum= products[1].unitPrice; 
// /**  console.log  islem sirasina uymadigi icin ekrana farkli bastiriyor. 
//  * Ama diger kodlarda islem sirasi oldugu gibi calismaktadir*/
// console.log("sum : " +sum);
